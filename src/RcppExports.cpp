...
RcppExport SEXP _evatopi1_cbind_rcpp(SEXP ASEXP, SEXP BSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _evatopi1_mMatrix_rcpp(SEXP ASEXP, SEXP BSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type A(ASEXP);
...
RcppExport SEXP _evatopi1_maxMin_cpp(SEXP matrixASEXP, SEXP matrixBSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _evatopi1_rbind_rcpp(SEXP ASEXP, SEXP BSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type A(ASEXP);
...
RcppExport SEXP _evatopi1_whichMax(SEXP matrix_ASEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _evatopi1_whichMin(SEXP matrix_ASEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type matrix_A(matrix_ASEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_evatopi1_cbind_rcpp", (DL_FUNC) &_evatopi1_cbind_rcpp, 2},
    {"_evatopi1_mMatrix_rcpp", (DL_FUNC) &_evatopi1_mMatrix_rcpp, 2},
    {"_evatopi1_maxMin_cpp", (DL_FUNC) &_evatopi1_maxMin_cpp, 2},
    {"_evatopi1_rbind_rcpp", (DL_FUNC) &_evatopi1_rbind_rcpp, 2},
    {"_evatopi1_whichMax", (DL_FUNC) &_evatopi1_whichMax, 1},
    {"_evatopi1_whichMin", (DL_FUNC) &_evatopi1_whichMin, 1},
    {NULL, NULL, 0}
};

RcppExport void R_init_evatopi1(DllInfo *dll) {
